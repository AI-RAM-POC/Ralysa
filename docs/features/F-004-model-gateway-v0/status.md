# F-004: Model Gateway v0 (one provider, vault credentials, per-call audit): Status

- **Current phase:** 2 – Requirements (brief drafted)
- **GitHub issue:** https://github.com/AI-RAM-POC/Ralysa/issues/7
- **Branch / PR:**
- **Release:**
