...
| TC-F-002-20 names the logs of TC-15 (rotation) too: `scans.int.ts` scans its own flows' logs; rotation logs join the scan once T13 lands | T13 or a follow-up to it | implementation-notes T14-11 |
