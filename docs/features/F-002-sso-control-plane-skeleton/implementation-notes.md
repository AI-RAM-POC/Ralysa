...
Branch `fix/F-002-openbao-refusal-all-entry-points`, based on `main` at `e6e6b98`, PR #PRNUM. Resolves T15-2 and R40-1, the G6 entry condition on TC-F-002-34 (SEC-F002-12, threat T-12).
