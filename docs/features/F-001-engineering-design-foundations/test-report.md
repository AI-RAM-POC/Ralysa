...
| TC-F-001-24 (AC-12, E2E chromium and firefox) | **Partial (D-F001-E2E-1 open)** | `keyboard.spec.ts`: forward walk, reading order, rings, Select, Checkbox, RadioGroup and buttons pass in both engines. Shift+Tab reverses fully in Chromium. In Firefox the test asserts the known D-F001-E2E-1 shape (stops at the RadioGroup), so other regressions still fail. | D-F001-E2E-1 |
