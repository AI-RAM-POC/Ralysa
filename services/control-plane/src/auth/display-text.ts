...
// override and isolate characters (U+202A–U+202E, U+2066–U+2069) and the invisible zero-width
// space, word joiner and BOM, then are cut to a maximum length. Arabic text and the RLM/LRM/ALM
// marks (U+200F, U+200E, U+061C) are kept, and so are ZWNJ and ZWJ (U+200C, U+200D): they are
// part of correct Persian and Urdu spelling in Arabic script, and of emoji sequences (review of
// #29). Nothing is normalised (AC-15).

/** C0 and DEL, C1, bidi embeddings/overrides, isolates, zero-width space, word joiner, BOM. */
